...
abstract class ContinuumBase {
    ...
    public forward<T extends Stage, U extends ContinuumBase>(toStage: T, params: any,
    ...
    public forwardWithSelector<T extends Stage, U extends ContinuumBase>(toStage: T, parameters: any,
        s: sb.Selector,
...
interface CacheStageInterface extends Stage { // Auto generated by tool connecting to ServiceBroker
    ...
    getDataAndProcess: (continuum: ContinuumBase, cs: CacheStageInterface, params: any) => void
}

interface DbStageInterface extends Stage { // Auto generated by tool connecting to ServiceBroker
    getThing(k: string): string
    cacheAndProcessData(continuum: ContinuumBase, dbs: DbStageInterface, params: any): void
}
...
interface ProcessingStageInterface extends Stage {// Auto generated by tool connecting to ServiceBroker
    ...
    processData: (continuum: ContinuumBase, pss: ProcessingStageInterface, params: any) => void;
}
