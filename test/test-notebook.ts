...
abstract class Stage {
    constructor(private continuum: ContinuumInterface,
...
abstract class ContinuumInterface {
    constructor(public serviceBrokerUrl) {}

    public forward<T extends Stage, U extends ContinuumInterface>(toStage: T, params: any,
    ...
    public forwardWithSelector<T extends Stage, U extends ContinuumInterface>(toStage: T, parameters: any,
        s: sb.Selector,
...
interface ContinuumInterfaceForStage extends ContinuumInterface {
    cacheStage: CacheStageInterface;
    dbStage: DbStageInterface;
    processingStage: ProcessingStageInterface;
}

class Continuum extends ContinuumInterface {
...
function cacheAndProcessData(continuum: ContinuumInterfaceForStage, dbs: DbStageInterface, params: any): void {
...
function processData(continuum: ContinuumInterfaceForStage, pss: ProcessingStageInterface, params: any): void {
...
//
// The stage developers would write these
