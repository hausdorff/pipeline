...
abstract class Stage {
    constructor(private continuum: ContinuumInterfaceForStage,
...
interface CacheStageInterface extends Stage { // Auto generated by tool connecting to ServiceBroker
    ...
    getDataAndProcess: (continuum: ContinuumInterfaceForStage, cs: CacheStageInterface, params: any) => void
}

interface DbStageInterface extends Stage { // Auto generated by tool connecting to ServiceBroker
    getThing(k: string): string
    cacheAndProcessData(continuum: ContinuumInterfaceForStage, dbs: DbStageInterface, params: any): void
}
...
interface ProcessingStageInterface extends Stage {// Auto generated by tool connecting to ServiceBroker
    ...
    processData: (continuum: ContinuumInterfaceForStage, pss: ProcessingStageInterface, params: any) => void;
}
